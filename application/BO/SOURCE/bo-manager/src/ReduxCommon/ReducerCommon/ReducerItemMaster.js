    ...
    UpdatePriceChangeItemMaster: (state, action) => {
      ...
      if (findItemMaster === undefined) {
        const CreateItemMaster = {
          ...
          DescriptionLong: action.payload.descriptionLong,
          DescriptionShort: action.payload.descriptionShort,
          HeadquartersLastUpdateDateTime:
            action.payload.headquartersLastUpdateDateTime,
          Note: action.payload.note,
          PairDiscountID: action.payload.pairDiscountID,
          Quantity: action.payload.quantity,
          QuantityDiscountID: action.payload.quantityDiscountID,
          SpecialDiscountID: action.payload.specialDiscountID,
          TaxGroupCodeID: action.payload.taxGroupCodeID,

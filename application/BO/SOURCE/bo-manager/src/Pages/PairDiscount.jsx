...
function PairDiscount() {
  ...
  useEffect(() => {
    ...
    const CheckTokenAndRole = async () => {
      ...
      // Get Event Code
      var eventCode = ConcatStringEvent(FistCode, EventPairDiscount);
      ...
      if (resultCheckRole.Status === true) {
        ...
        dispatch(OldURLReducer.actions.AddUrl("/pairdiscount"));
        window.localStorage.setItem("oldURL", "/pairdiscount");

        // Setting Title Page
        document.title = "PairDiscount";

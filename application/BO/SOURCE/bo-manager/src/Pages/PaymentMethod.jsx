...
function PaymentMethod() {
  ...
  useEffect(() => {
    ...
    const CheckTokenAndRole = async () => {
      ...
      // Get Event Code
      var eventCode = ConcatStringEvent(FistCode, EventPaymentMethod);
      ...
      if (resultCheckRole.Status === false) {
        ...
        dispatch(OldURLReducer.actions.AddUrl("/paymentmethod"));
        window.localStorage.setItem("oldURL", "/paymentmethod");

        // Setting Title Page
        document.title = "PaymentMethod";

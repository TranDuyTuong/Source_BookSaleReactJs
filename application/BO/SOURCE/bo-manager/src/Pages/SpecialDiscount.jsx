...
function SpecialDiscount() {
  ...
  useEffect(() => {
    ...
    const CheckTokenAndRole = async () => {
      ...
      // Get Event Code
      var eventCode = ConcatStringEvent(FistCode, EventSpecialDiscount);
      ...
      if (resultCheckRole.Status === true) {
        ...
        dispatch(OldURLReducer.actions.AddUrl("/specialdiscount"));
        window.localStorage.setItem("oldURL", "/specialdiscount");

        // Setting Title Page
        document.title = "SpecialDiscount";

...
function ImageItemMaster() {
  ...
  useEffect(() => {
    ...
    const CheckTokenAndRole = async () => {
      ...
      // Get Event Code
      var eventCode = ConcatStringEvent(FistCode, EventImageItemMaster);
      ...
      if (resultCheckRole.Status === true) {
        ...
        dispatch(OldURLReducer.actions.AddUrl("/imageitemmaster"));
        window.localStorage.setItem("oldURL", "/imageitemmaster");

        // Setting Title Page
        document.title = "ImageItemMaster";
...
export default ImageItemMaster;

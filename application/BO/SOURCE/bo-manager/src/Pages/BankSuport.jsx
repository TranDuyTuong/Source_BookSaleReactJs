...
function BankSuport() {
  ...
  useEffect(() => {
    ...
    const CheckTokenAndRole = async () => {
      ...
      // Get Event Code
      var eventCode = ConcatStringEvent(FistCode, EventBankSuport);
      ...
      if (resultCheckRole.Status === true) {
        ...
        dispatch(OldURLReducer.actions.AddUrl("/banksuport"));
        window.localStorage.setItem("oldURL", "/banksuport");

        // Setting Title Page
        document.title = "BankSuport";

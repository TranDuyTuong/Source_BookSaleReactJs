...
namespace CodeFirtMigration.Migrations
{
    ...
    [Migration("20230708042008_TXTCloud_V4")]
    partial class TXTCloud_V4
    {
            ...
            modelBuilder.Entity("TDTSettingTable.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleID = "0000Admin",
                            ConcurrencyStamp = "828530c4-4412-451e-a8e1-0db5bdd75206",
            ...
            modelBuilder.Entity("TDTSettingTable.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = "05032000",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "40967f3b-683f-4913-a101-e8125c95cd43",
                            DateCreate = new DateTime(2023, 7, 8, 0, 0, 0, 0, DateTimeKind.Local),
                            Email = "duytuong0503@gmail.com",
                            EmailConfirmed = true,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPXm1kvn+6t+WVgZp7ueuZ+xMAoK0bB2Gi0PBKybJy06u86z7GX35SjUEQIjdtn1nA==",

using CodeFirtMigration.DataExtestion;
...
namespace CodeFirtMigration.DataFE
{
    public class ContextFE : IdentityDbContext<UserAccount, Role, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new TemplateImportConfiguration());
        ...
        public DbSet<TemplateImport> templateImports { get; set; }
